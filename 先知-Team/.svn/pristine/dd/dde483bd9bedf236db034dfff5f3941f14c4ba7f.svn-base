...
<body
	...
	<div class="loginbody">
		...
		<div class="loginbox">
			...
			<form action="backStageLogin_UserAction" method="post">
				<ul>
					<li><input name="user.loginId" type="text" class="loginuser" value="账号"
						onclick="JavaScript:this.value=''" /></li>
					<li><input name="user.pwd" type="password" class="loginpwd" value="密码"
						onclick="JavaScript:this.value=''" /></li>
