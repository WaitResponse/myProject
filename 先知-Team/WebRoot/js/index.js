 ...
 */
(function () {
  let bannerImgArc =['${currUser.headImg}','images/15.jpg','images/12.jpg','images/5.jpg','images/6.jpg','images/7.jpg']; //轮播图src
  let bannerTitle = ['热点','社会','娱乐','体育','科技','国际'];
  ...
  function bannerPic() {
    ...
    for(let i = 0; i < bannerImgArc.length; i++){
      $imgCta.append('<a href="index.html"><img class="bannerImg" src='+ bannerImgArc[i] +'/></a>');
