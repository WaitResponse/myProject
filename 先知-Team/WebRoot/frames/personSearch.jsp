...
<div class="g-container" style="width: 100%;height: auto;">
    ...
    <div class="news-nav" style="width: 1000px;margin: 15px auto">
        <ul class="g-c">
            ...
            <li class="news-li-active"><a>用户</a></li>
			...
			<c:otherwise>
				<c:forEach items="${userList2 }" var="user">
					<div style="width:600px;height:70px;">
						<div class="item-inner-img sc-tr" style="width:60px;height:60px;border-radius:50%;">
                             <a href="loadCollectNews_UserCenterAction?user.id=${user.id }">
                                 <img src="${user.headImg }"/>
                             </a>
                        </div>
                        <div class="item-inner-title">
                            <a href="loadCollectNews_UserCenterAction?user.id=${user.id }"
                            class="it-news-tl" style="margin-left:-350px;margin-top:-20px;">${user.nickName}</a> 
						</div> 
					</div>
				</c:forEach>
			</c:otherwise>
