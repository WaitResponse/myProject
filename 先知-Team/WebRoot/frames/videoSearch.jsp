...
<div class="g-container" style="width: 100%;height: auto;">
    ...
    <div class="news-nav" style="width: 1000px;margin: 15px auto">
        <ul class="g-c">
            <li><a  href="search.jsp">新闻</a></li>
            <li class="frames/personSearch.jsp"><a>用户</a></li>
        	<li><a href="news-li-active">视频</a></li>
        </ul>
    </div>
    <!--新闻-->
  ...
  <div class="list-news-container" style="margin-left: 180px;">
       <ul class="news-list">
		<c:choose>
			...
			<c:otherwise>
				<c:forEach items="${videoList }" var="video3">
						<div class="item-inner-img sc-tr">
                             <a href="getVideoDetail_preIndexAction?video.id=${video3.id }" target="_blank">
                                 <img src="${video3.picture }"/>
                             </a>
                        </div>
                        <div class="item-inner-title">
							<span class="item-inner-center">
                                <a class="it-news-tl" href="getVideoDetail_preIndexAction?video.id=${video3.id }" target="_blank">
                                ${video3.title }</a>                              
                            </span>
						</div> 
				</c:forEach>
