		...
		<!--右边新闻列表-->
                <div class="r-news-list jincai-pic">
                    <div class="r-list-lf r-news-rg">
                    	<div>
	                       <a href="loadCollectNews_UserCenterAction?user.id=${video1.author.id }" target="_blank">
	                       <img src="${video1.author.headImg }" style="width: 50px;height: 50px;"/></a>
	                       <a><span style="font-weight: bold;">${video1.author.nickName }</span></a>
